...
class MatchLogTest {
    ...
    // EFFECTS: checks the added Apex match in the match log
    @Test
    void testAddToList() {
    ...
    // EFFECTS: checks the matches placed in the Apex match list
    @Test
    void testGetMatches() {
        apexMatchList.add(apexMatch);
        matchSummary.addToList(apexMatch);
    ...
    // EFFECTS: checks the Apex match data
    @Test
    ...
    // EFFECTS: checks the size of the match log
    @Test
    void testNumMatches() {
        assertEquals(0, matchSummary.numMatches());
    }

    // EFFECTS: checks the added Apex match data and what it prints to the console
    @Test
    void testPrintSummaryLog() throws PlacementNotWithinRange {
        apexMatch.storeRankedDivision("bronze");
    ...
    // EFFECTS: checks the name of the JSON file
    @Test
    void testToJson() {
    ...
    // EFFECTS: checks the information inputted into the JSON file
    @Test
